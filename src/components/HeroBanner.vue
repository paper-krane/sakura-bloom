    ...
    <section class="pk__hero_section pk__section-padding-bot" ref="heroImageContainer" @mousemove="mouseMoveHandler" @mouseleave="mouseLeaveHandler">
        <div class="pk__hero_image" ref="heroImageWrapRef">
            <div class="pk__hero_image-container">
                <img 
                    ref="heroImageRef"
                    src="https://storageciggallery.addons.business/18193/cig-cozy-gallery-11474CdG-0622-Newport-Onbuhimos-13-hd.jpg?c=00" 
                    alt="Hero Image" 
                />
            </div>
            ...
            <div class="pk__container">
                <h1>
                    <div class="pk__hero_overflow-hidden">
                        <span class="pk__heading-accent pk__hero_content-reveal">Hand-woven Baby Carriers </span>
                    </div>
                    <div class="pk__hero_overflow-hidden">
                        <span class="pk__hero_content-reveal">Facilitating parent/child connection </span>
                    </div>
                    <div class="pk__hero_overflow-hidden">
                        <span class="pk__hero_content-reveal"><span class="pk__text-italic">for</span> over 18 years</span>
                    </div>
                </h1>
                <div class="pk__hero_overflow-hidden">
                    <span class="pk__hero_content-reveal" @mouseenter="buttonHovered = true" @mouseleave="buttonHovered = false">
                        <Button href="#">Browse Carriers</Button>
                    </span>
                </div>
            </div>
        </div>
