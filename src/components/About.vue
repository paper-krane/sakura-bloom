...
// Images
import image1 from '@/assets/images/image_005upscaled.webp';
import image2 from '@/assets/images/image_007upscaled.webp';

// Ref's
const words = computed(() => {
    const paraStr = 'With the softest hand-dyed linens, silks, coziest cashmere, and signature Italian leathers we have been proud to promote and enable mothers and fathers alike to practice an ancient art of baby wearing, with a comfortable yet elegant baby carrier design.';
